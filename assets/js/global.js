...
(function( $ ) {
	...
	*/
	...
	document.querySelector('.menu__header').classList.toggle('animate');
	document.querySelector('body').classList.toggle('vertical__hidden');
});
