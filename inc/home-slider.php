...
function slider_background_callback( $post, $meta ) {
	...
	<div class="fields-list">
		...
		<div class="clearfix" style="clear:both"><?php the_field('name_text'); ?></div>
	</div>
	<?php
}
		...
		<div id="home-slider" class="slick-slider home-slider">
           ...
           <?php wp_reset_query();?>
            <div class="wrapper__img">
                <?php
                $image = get_field('name_image');
                if( !empty( $image ) ): ?>
                    <img class="title__img" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                <?php endif; ?>
            </div>
